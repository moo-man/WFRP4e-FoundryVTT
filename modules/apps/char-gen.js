...
class TrappingStage extends ChargenStage
{
  ...
  constructor(...args)
  {
    ...
    this.context.classStrings = game.wfrp4e.config.classTrappings[this.data.items.career.class.value + "s"].split(",")
    this.context.careerStrings = this.data.items.career.trappings

    this.context.class = Promise.all(game.wfrp4e.config.classTrappings[this.data.items.career.class.value + "s"].split(",").map(i => WFRP_Utility.find(i.trim(), "trapping")))
    this.context.career = Promise.all(this.data.items.career.trappings.map(i => WFRP_Utility.find(i, "trapping")))
  }
