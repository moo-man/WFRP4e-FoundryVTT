...
export class EffectWfrp4eV2 extends ActiveEffect
{
    ...
    // {
    //     let effects = foundry.utils.deepClone(game.wfrp4e.config.conditions).concat(foundry.utils.deepClone(Object.values(game.wfrp4e.config.zoneEffects)));

    //     let effect = effects.find(i => i.id == key && i.flags?.wfrp4e?.type == type);
    //     if (!effect)
    //     {
