...
export default function () {
  ...
  //     systemset = { type, id: broken ? null : document.id };
  //   }
  ...
  //     systemset = {type, playlistId, soundId};
  ...
  //     if ( pack ) {
  //       systemset = {pack: pack.collection};
  ...
  //   a.draggable = true;
  //   for (let [k, v] of Object.entries(systemset)) {
  //     a.dataset[k] = v;
  //   }
  ...
  //         continue;
  //       }
  //       promises.push(this._drawEffect(f.data.icon, i, bg, w, tint, getProperty(f, "flags.wfrp4e.value")));
  //       i++;
  //     }
