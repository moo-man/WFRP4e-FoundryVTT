...
export default class TestWFRP {
  ...
  async runPreEffects() {
    ...
    {
      await this.actor.runScripts("preRollTest", { test: this, cardOptions: this.context.cardOptions })
  ...
  async runPostEffects() {
    if (!this.context.unopposed)
    {
      await this.actor.runScripts("rollTest", { test: this, cardOptions: this.context.cardOptions }, {item : this.item})
